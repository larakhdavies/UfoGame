...
const { displayUfo } = require('./ufo_display');
const updateDataBase = require('./databaseQueries');
...
class UfoGame {
  ...
  playAgainPrompt(bool) {
    updateDataBase.updateDataBase(bool, this.incorrectGuesses, this.correctGuesses);
